...
public class AppConstants {
  ...
  public static String INITIAL_URL = "exp://exp.host/@larkintuckerllc/hello-document-picker";
  public static final boolean IS_DETACHED = true;
  public static final String SHELL_APP_SCHEME = "exp52a65fdfce9f403b9c15f20bb6f1adf4";
  ...
  static {
    List<Constants.EmbeddedResponse> embeddedResponses = new ArrayList<>();
        ...
        embeddedResponses.add(new Constants.EmbeddedResponse("https://exp.host/@larkintuckerllc/hello-document-picker/index.exp", "assets://shell-app-manifest.json", "application/json"));
        embeddedResponses.add(new Constants.EmbeddedResponse("https://d1wp6m56sqw74a.cloudfront.net/%40larkintuckerllc%2Fhello-document-picker%2F1.0.0%2F4e5d82b1fb2f1914010f2449c21c6b49-30.0.0-android.js", "assets://shell-app.bundle", "application/javascript"));
